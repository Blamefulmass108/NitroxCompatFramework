...
| LockerLabels                            |               1.3.0 |    🟡  |  Partially Working | Labels work local, but are not synced. Needs to be updated or NCF bridged.¹     | https://www.nexusmods.com/subnautica/mods/3785 |
...
* Currently **73 community mods** have been evaluated with Nitrox Compatibility Framework.
