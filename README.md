...
Nitrox Compatibility Framework v1.0.0 is the first public release of NCF.
...
- Uses lightweight runtime patching with no changes required to Nitrox or supported mods.
